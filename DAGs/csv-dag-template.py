...
flex_template = 'csv-flex-template.json'  
stage = '<STAGE>'  
...
allow_accum_date = '<ALLOW_ACCUM_DATE>'   
allow_multi_file = '<ALLOW_MULTI_FILE>'         
...
with models.DAG(
    ...
    description='Pipeline para leer archivos CSV y cargar en bigquery',
